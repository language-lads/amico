...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "amico_production"
  ...
  # Mail setup
  config.action_mailer.default_url_options = { host: 'amico.language-lads.com' }
  config.action_mailer.delivery_method = :smtp
  config.action_mailer.smtp_settings = {
    address: 'smtp.gmail.com',
    port: 587,
    domain: 'tombarone.net',
    user_name: Rails.application.credentials.action_mailer.gmail.username!,
