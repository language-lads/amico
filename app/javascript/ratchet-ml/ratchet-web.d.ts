...
* @returns {Promise<Model>}
*/
  static load_custom(endpoint: string, model: AvailableModels, quantization: Quantization, progress: Function): Promise<Model>;
/**
...
export interface InitOutput {
  ...
  readonly model_load_custom: (a: number, b: number, c: number, d: number, e: number) => number;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he44b7e8d64fbf3a8: (a: number, b: number, c: number, d: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h19644a8fcacc8ff6: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc67d0b1ff3e9a739: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__Fn__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h8960fcfa95665b9f: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hbdaa6c0a8b9b76db: (a: number, b: number) => void;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h2e58edd080fcb322: (a: number, b: number, c: number, d: number) => void;
