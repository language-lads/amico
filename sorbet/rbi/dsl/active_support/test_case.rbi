...
class ActiveSupport::TestCase
  sig { params(fixture_name: NilClass, other_fixtures: NilClass).returns(T::Array[Conversation]) }
  sig { params(fixture_name: T.any(String, Symbol), other_fixtures: NilClass).returns(Conversation) }
  sig do
    params(
  ...
  def conversations(fixture_name = nil, *other_fixtures); end
